        ...
        <Card className="mb-8">
          <div className="p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Founded in 2020, E-Shop has grown from a small startup to one of the
              leading e-commerce platforms. Our mission is to provide quality
              products at affordable prices while delivering exceptional customer
              service.
            </p>
            <p className="text-gray-700 leading-relaxed">
              We believe in making online shopping easy, secure, and enjoyable for
              everyone. With a vast selection of products across multiple
